            ...
            <div className="row g-0 d-flex flex-column-reverse flex-md-row">
              ...
              <div className="col-md">
                <div className="row row-cols-1 gy-md-10 gy-6">
                  <div className="col">
                    < ProductLmg img={productDisplay[0].image_url} product={productDisplay[0].title} />
                  </div>
                  <div className="col">
                    <div className="row gx-md-10 gx-6">
                      <div className="col">
                        < ProductLmg img={productDisplay[0].image_url_01} product={productDisplay[0].title} />
                      </div>
                      <div className="col">
                        < ProductLmg img={productDisplay[0].image_url_02} product={productDisplay[0].title} />
                      </div>
                      <div className="col">
                        < ProductLmg img={productDisplay[0].image_url_03} product={productDisplay[0].title} />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="container container-index">
          ...
          <div className="row g-0 d-flex flex-column flex-md-row">
            <div className="col-md">
              <div className="row row-cols-1 gy-md-10 gy-6">
                <div className="col">
                  < ProductLmg img={productDisplay[1].image_url} product={productDisplay[0].title} />
                </div>
                <div className="col">
                  <div className="row gx-md-10 gx-6">
                    <div className="col">
                      < ProductLmg img={productDisplay[1].image_url_01} product={productDisplay[0].title} />
                    </div>
                    <div className="col">
                      < ProductLmg img={productDisplay[1].image_url_02} product={productDisplay[0].title} />
                    </div>
                    <div className="col">
                      < ProductLmg img={productDisplay[1].image_url_03} product={productDisplay[0].title} />
                    </div>
                  </div>
                </div>
              </div>
